...
class TrainingDataset(Dataset):
    def __init__(self, dataset_path, query_filename, transform=None, set_transform=None):
        ...
        self.dataset_path = "/mydata/home/oem/minwoo/PR"
        self.query_filepath = os.path.join(dataset_path, query_filename)
        assert os.path.exists(self.query_filepath), 'Cannot access query file: {}'.format(self.query_filepath)
        sys.path.append(r'/mydata/home/oem/minwoo/MinkLoc3Dv2/datasets')
...
class PointCloudLoader:
    ...
    def __call__(self, file_pathname):
        ...
        # if "/mydata/home/oem/minwoo/PR/training" in file_pathname:
        #     file_pathname=file_pathname.replace("/mydata/home/oem/minwoo/PR/training", "/mydata/home/oem/minwoo/PR/velodyne_data/training")
        # elif "/mydata/home/oem/minwoo/PR/validation" in file_pathname:
        #     file_pathname=file_pathname.replace("/mydata/home/oem/minwoo/PR/validation", "/mydata/home/oem/minwoo/PR/velodyne_data/validation")
