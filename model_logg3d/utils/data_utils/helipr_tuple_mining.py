...
#                 with open( basedir + "/" + parent_seq + "-" + child_seq +  '/scan_poses.csv', newline='') as f:
#                     reader = csv.reader(f)
...
def get_positive_dict(basedir, sequences, output_dir, d_thresh, t_thresh):
    ...
    for grandparent_seq in seq_dict:
        ...
        with open("/mydata/home/oem/minwoo/PR/overlap_matrix_training_NCLT_overlap_nn.txt", 'rb') as file :
...
#     save_file_name = '{}/positive_sequence_D-{}_T-{}_Aeva.json'.format(
#         output_dir, d_thresh, t_thresh)
#     with open(save_file_name, 'w') as f:
#         json.dump(positive_dict, f)
#     print('Saved: ', save_file_name)
...
if __name__ == "__main__":
    ...
    # # only Aeva
    # sequences = [
    #     'DCC04-Ouster', 'DCC05-Ouster', 'DCC06-Ouster',
    #     'KAIST04-Ouster', 'KAIST05-Ouster', 'KAIST06-Ouster',
    #     'Riverside04-Ouster', 'Riverside05-Ouster', 'Riverside06-Ouster',
    # ]
    sequences = ["NCLT01-Velodyne",  "NCLT02-Velodyne",  "NCLT03-Velodyne",  "NCLT04-Velodyne",  "NCLT05-Velodyne",  "NCLT06-Velodyne",  "NCLT07-Velodyne",  "NCLT08-Velodyne"]
    
    output_dir = os.path.join(os.path.dirname(
        __file__), '../../config/helipr_tuples/')

    t_thresh = 0
    get_positive_dict(basedir, sequences, output_dir, 0.8, t_thresh)
    get_positive_dict(basedir, sequences, output_dir, 0.001, t_thresh)
    # get_positive_dict(basedir, sequences, output_dir, 0.6, t_thresh)
    # get_positive_dict(basedir, sequences, output_dir, 0.3, t_thresh)
    # get_positive_dict(basedir, sequences, output_dir, 0.001, t_thresh)
