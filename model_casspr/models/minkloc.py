...
class PNT_GeM(nn.Module):
    def __init__(self, p=3, eps=1e-6, kernel=(8192,1)):
...
class MinkLoc(torch.nn.Module):
    def __init__(self, backbone, pooling, in_channels, feature_size, output_dim, planes, layers, num_top_down, conv0_kernel_size, num_points, combine_params, dataset_name='HeLiPR'):
        super().__init__()
