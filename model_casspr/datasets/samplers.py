...
from datasets.helipr import HeLiPRDataset
...
class BatchSampler(Sampler):
    ...
    def __init__(self, dataset: HeLiPRDataset, batch_size: int, batch_size_limit: int = None,
...
if __name__ == '__main__':
    ...
    ds = HeLiPRDataset(dataset_path, query_filename)
