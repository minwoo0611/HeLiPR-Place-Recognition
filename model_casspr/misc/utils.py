...
class ModelParams:
    ...
    def get_combine_params(self, config, combine_modules):
        ...
        print('with_pntnet: {}, with_cross_att: {}'.format(with_pntnet, with_cross_att))
...
class MinkLocParams:
    """
    Params for training MinkLoc models on HeLiPR dataset
    """
    ...
    def __init__(self, params_path, model_params_path):
        ...
        self.dataset_name == 'HeLiPR'
        self.eval_database_files = params.get('eval_database_files', 'helipr_validation_database.pickle')
        self.eval_query_files = params.get('eval_query_files', 'helipr_validation_query.pickle')
